...
namespace TexAuto.Migrations
{
    ...
    [Migration("20250606144815_AddedSeedingForGroupMaster")]
    partial class AddedSeedingForGroupMaster
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Project.Models.Domain.Creation.BalePurchase", b =>
                {
                    ...
                    b.Property<string>("TransportVendor")
                        .HasColumnType("nvarchar(max)");
